 ...
 */
final class Version20210711135501 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE evenement (id INT AUTO_INCREMENT NOT NULL, salle_de_sport_id INT DEFAULT NULL, categorie_id INT DEFAULT NULL, id_evenement INT NOT NULL, titre VARCHAR(255) DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, date_debut DATE DEFAULT NULL, date_fin DATE DEFAULT NULL, duree DOUBLE PRECISION DEFAULT NULL, lieu VARCHAR(255) DEFAULT NULL, image VARBINARY(255) DEFAULT NULL, INDEX IDX_B26681E264AE1D7 (salle_de_sport_id), INDEX IDX_B26681EBCF5E72D (categorie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE membre (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT DEFAULT NULL, abonnement_id INT DEFAULT NULL, id_membre INT NOT NULL, date_de_naissance DATE NOT NULL, est_membre TINYINT(1) DEFAULT NULL, poids DOUBLE PRECISION DEFAULT NULL, taille DOUBLE PRECISION DEFAULT NULL, nom VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_F6B4FB29FB88E14F (utilisateur_id), INDEX IDX_F6B4FB29F1D74413 (abonnement_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE nutritionniste (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) DEFAULT NULL, prenom VARCHAR(255) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, conseil VARCHAR(255) DEFAULT NULL, disponibilite TINYINT(1) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE salle_de_sport (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT DEFAULT NULL, id_salle_de_sport INT NOT NULL, description VARCHAR(255) DEFAULT NULL, addresse VARCHAR(255) DEFAULT NULL, nom VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_D533E789FB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE utilisateur (id INT AUTO_INCREMENT NOT NULL, id_utilisateur VARCHAR(255) NOT NULL, motdepasse VARCHAR(255) NOT NULL, lattitude INT NOT NULL, longitude INT NOT NULL, attribute VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, type_utilisateur VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
